...
fig <- ggplot(GDP.distr, aes(x = ID, y = value, fill = variable)) +
...
fig; # ggsave("C:/Users/Tom/Desktop/GDP_distribution.png", fig, dpi = 500, width = 14, height = 10, units = "in", bg = "transparent") 
...
cdf; # ggsave("C:/Users/Tom/Desktop/GDP_cdf.png", cdf, dpi = 500, width = 3.615, height = 1.815, units = "in", bg = "transparent")
